...
class DataTable extends StatelessWidget {
  ...
  final Map<int, double> columnPaddings;
  ...
  static const double _tablePadding = 12.0;
  static const double _columnSpacing = 30.0;
  ...
  Widget build(BuildContext context) {
    ...
    for (int dataColumnIndex = 0; dataColumnIndex < columns.length; dataColumnIndex += 1) {
      ...
      final double columnPadding = columnPaddings[dataColumnIndex]!=null?columnPaddings[dataColumnIndex]:_columnSpacing;
      final EdgeInsetsDirectional padding = EdgeInsetsDirectional.only(
        start: dataColumnIndex == 0 ? showCheckboxColumn ? _tablePadding / 2.0 : _tablePadding : _columnSpacing / 2.0,
	end: columnPadding / 2.0,
        //end: dataColumnIndex == columns.length - 1 ? _tablePadding : columnPadding / 2.0,
      );
